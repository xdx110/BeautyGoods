...
public class GoodsAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Glide.with(context).load(goodsBean.getData().getActivities().get(i).getImages().get(0)).error(R.mipmap.icon_splash).into(holder.headImage);
        holder.headText.setText(goodsBean.getData().getActivities().get(i).getDigest().substring(0, 23));
        holder.endText.setText(goodsBean.getData().getActivities().get(i).getDigest().substring(23, 35));
    ...
    class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            endText = (TextView) view.findViewById(R.id.goods_end_text_show);
